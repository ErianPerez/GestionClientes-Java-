...
public class ClienteDao {
    ...
    public Connection conectar(){
        ...
        String cadenaConexion = "jdbc:mysql://" + host + ":" + puerto + "/" + baseDeDatos + "?useSSL=false";
    ...
    public void actualizar(Cliente cliente){
        try {
            Connection conexion = conectar();
            String sql = "UPDATE `clientes` SET `nombre`='"+ cliente.getNombre() + "', `apellido`='"+ cliente.getApellido() +"', `telefono`='"+ cliente.getTelefono() +"', `email`='"+ cliente.getEmail() +"');";
            Statement statement = conexion.createStatement();
            statement.execute(sql);
